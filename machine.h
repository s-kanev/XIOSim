...
#define F_REPABLE     0x80000000    /* inst cares about REP prefixes */
...
#ifndef SET_TPC
#define SET_TPC(PC)    Mop->decode.targetPC = (PC)
#define SET_TPC_D(PC)    Mop->decode.targetPC = (PC)
#define SET_TPC_V(PC)    Mop->decode.targetPC = (PC)
#endif /* SET_TPC */
