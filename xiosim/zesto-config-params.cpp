...
cfg_opt_t dvfs_cfg[]{ CFG_STR("config", "none", CFGF_NONE), CFG_INT("interval", 0, CFGF_NONE),
                      CFG_END() };

cfg_opt_t scheduler_cfg[]{ CFG_INT("scheduler_tick", 0, CFGF_NONE),
...
cfg_opt_t system_cfg[]{ CFG_BOOL("assert_spin", cfg_false, CFGF_NONE),
                        ...
                        CFG_INT("cache_miss_sample_parameter", 0, CFGF_NONE),
...
/********* Instruction cache ****************/
/********************************************/
cfg_opt_t iprefetch_cfg[]{ CFG_STR_LIST("config", "none", CFGF_NONE),
...
cfg_opt_t itlb_cfg[]{ CFG_STR("config", "ITLB:32:4:1:3:L:1", CFGF_NONE),
                      CFG_STR("coherency_controller", "none", CFGF_NONE), CFG_END() };

cfg_opt_t icache_cfg[]{ CFG_STR("config", "IL1:64:8:64:4:16:3:L:8", CFGF_NONE),
                        CFG_STR("coherency_controller", "none", CFGF_NONE),
                        CFG_FLOAT("magic_hit_rate", -1.0, CFGF_NONE),
                        CFG_BOOL("sample_misses", cfg_false, CFGF_NONE),
...
/************* L1 data cache ****************/
/********************************************/
cfg_opt_t dprefetch_cfg[]{ CFG_STR_LIST("config", "nextline", CFGF_NONE),
...
cfg_opt_t dtlb_cfg[]{ CFG_STR("config", "DTLB:4:4:1:2:L:4", CFGF_NONE),
                      CFG_STR("coherency_controller", "none", CFGF_NONE), CFG_END() };

cfg_opt_t d2tlb_cfg[]{ CFG_STR("config", "none", CFGF_NONE),
                       CFG_STR("coherency_controller", "none", CFGF_NONE), CFG_END() };

cfg_opt_t dcache_cfg[]{ CFG_STR("config", "DL1:64:8:64:8:64:2:L:W:T:8:C", CFGF_NONE),
...
/***************** L2 cache *****************/
/********************************************/
cfg_opt_t l2prefetch_cfg[]{ CFG_STR_LIST("config", "nextline", CFGF_NONE),
                            CFG_BOOL("on_miss_only", cfg_true, CFGF_NONE),
                            CFG_INT("fifosize", 8, CFGF_NONE),
                            CFG_INT("buffer", 0, CFGF_NONE),
                            CFG_INT("filter", 0, CFGF_NONE),
...
cfg_opt_t l2cache_cfg[]{ CFG_STR("config", "DL2:512:8:64:8:64:9:L:W:T:8:C", CFGF_NONE),
                         CFG_STR("coherency_controller", "none", CFGF_NONE),  // CB
                         CFG_FLOAT("magic_hit_rate", -1.0, CFGF_NONE),
                         CFG_BOOL("sample_misses", cfg_false, CFGF_NONE),
...
/********** Last level cache ****************/
/********************************************/
cfg_opt_t llcprefetch_cfg[]{ CFG_STR_LIST("config", "none", CFGF_NONE),
                             CFG_BOOL("on_miss_only", cfg_false, CFGF_NONE),
...
cfg_opt_t llccache_cfg[]{ CFG_STR("config", "LLC:2048:16:64:16:64:12:L:W:B:8:1:8:C", CFGF_NONE),
                          CFG_STR("coherency_controller", "none", CFGF_NONE),  // CB
...
/*********** Pipeline stages ****************/
/********************************************/
cfg_opt_t byte_queue_cfg[]{ CFG_INT("size", 4, CFGF_NONE), CFG_INT("line_size", 16, CFGF_NONE),
                            CFG_END() };

cfg_opt_t predecode_cfg[]{ CFG_INT("depth", 2, CFGF_NONE), CFG_INT("width", 4, CFGF_NONE),
                           CFG_END() };

cfg_opt_t branch_pred_cfg[]{ CFG_STR_LIST("type", "2lev:gshare:1:1024:6:1", CFGF_NONE),
...
cfg_opt_t fetch_cfg[]{ CFG_INT("instruction_queue_size", 8, CFGF_NONE),
...
cfg_opt_t uop_fusion_cfg[]{ CFG_BOOL("load_comp_op", cfg_false, CFGF_NONE),
                            CFG_BOOL("fpload_comp_op", cfg_false, CFGF_NONE),
                            CFG_BOOL("sta_std", cfg_false, CFGF_NONE),
                            CFG_BOOL("load_op_store", cfg_false, CFGF_NONE), CFG_END() };

cfg_opt_t decode_cfg[]{ CFG_INT("depth", 3, CFGF_NONE),
...
cfg_opt_t alloc_cfg[]{ CFG_INT("depth", 2, CFGF_NONE), CFG_INT("width", 4, CFGF_NONE),
                       CFG_BOOL("use_drain_flush", cfg_false, CFGF_NONE), CFG_END() };
...
cfg_opt_t exeu_cfg[]{ CFG_INT("latency", 1, CFGF_NONE), CFG_INT("rate", 1, CFGF_NONE),
                      CFG_INT_LIST("port_binding", "{0}", CFGF_NONE), CFG_END() };

// Execution pipeline stage configuration.
cfg_opt_t exec_cfg[]{ CFG_INT("width", 4, CFGF_NONE),
...
cfg_opt_t commit_cfg[]{ CFG_INT("rob_size", 64, CFGF_NONE), CFG_INT("commit_width", 4, CFGF_NONE),
                        CFG_INT("commit_branches", 2, CFGF_NONE),
                        CFG_INT("precommit_depth", 2, CFGF_NONE), CFG_END() };

cfg_opt_t core_cfg[]{ CFG_FLOAT("core_clock", 4000.0, CFGF_NONE),
...
cfg_opt_t fsb_cfg[]{ CFG_INT("width", 4, CFGF_NONE), CFG_BOOL("ddr", cfg_false, CFGF_NONE),
                     CFG_FLOAT("clock", 100.0, CFGF_NONE), CFG_BOOL("magic", cfg_false, CFGF_NONE),
                     CFG_END() };

cfg_opt_t dram_cfg[]{ CFG_STR("memory_controller_config", "simple:4:1", CFGF_NONE),
                      CFG_STR("dram_config", "simplescalar:80", CFGF_NONE), CFG_END() };

cfg_opt_t uncore_cfg[]{ CFG_SEC("llccache_cfg", llccache_cfg, CFGF_TITLE),
                        CFG_SEC("fsb_cfg", fsb_cfg, CFGF_NONE),
                        CFG_SEC("dram_cfg", dram_cfg, CFGF_NONE), CFG_END() };

// Global view of all configuration options.
cfg_opt_t top_level_cfg[]{ CFG_SEC("system_cfg", system_cfg, CFGF_NONE),
                           CFG_SEC("core_cfg", core_cfg, CFGF_NONE),
                           CFG_SEC("uncore_cfg", uncore_cfg, CFGF_NONE), CFG_END() };
