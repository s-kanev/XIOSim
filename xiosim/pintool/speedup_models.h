...
class LinearSpeedupModel : public BaseSpeedupModel {
  public:
    LinearSpeedupModel(double core_power,
                       double uncore_power,
                       int num_cores,
    ...
    void OptimizeEnergy(std::map<int, int>& core_allocs,
    ...
    double
    ComputeRuntime(int num_cores_alloc, double process_scaling, double process_serial_runtime);
...
class LogSpeedupModel : public BaseSpeedupModel {
  public:
    LogSpeedupModel(double core_power,
                    double uncore_power,
                    int num_cores,
                    OptimizationTarget target = OptimizationTarget::THROUGHPUT)
        : BaseSpeedupModel(core_power, uncore_power, num_cores, target) {}
