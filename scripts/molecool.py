...
ENVIRONMENT="ILDJIT_HOME=%s ILDJIT_PATH=.:%s/lib/cscc/lib:%s/lib/gcc4cli LD_LIBRARY_PATH=/usr/lib:/usr/local/lib:/lib:%s/lib/iljit PKG_CONFIG_PATH=%s/lib/pkgconfig PATH=%s/bin:/lib:/usr/lib:/usr/bin ILDJIT_CACHE=/home/skanev HOME=/home/skanev " % (ILDJIT_HOME, ILDJIT_HOME, ILDJIT_HOME, ILDJIT_HOME, ILDJIT_HOME, ILDJIT_HOME) 
