...
TEST_CASE("Energy optimization under linear speedup") {
    ...
    LinearSpeedupModel speedup_model(
            .125, 1, num_cores, OptimizationTarget::ENERGY);
...
TEST_CASE("Throughput optimization under linear scaling") {
    ...
    int num_cores = 32;
    LinearSpeedupModel speedup_model(
            0.125, 1, num_cores, OptimizationTarget::THROUGHPUT);
...
TEST_CASE("Energy optimization under logarithmic speedup") {
    ...
    std::vector<double> process_serial_runtime;
    int num_cores = 32;
    LogSpeedupModel speedup_model(
            0.125, 1, num_cores, OptimizationTarget::ENERGY);
