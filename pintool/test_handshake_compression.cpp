...
TEST_CASE("Compression-decompression test", "compression") {
    ...
    SECTION("INT state") {
        ...
        ctxt.producer_handshake.handshake.ctxt.regs_R.dw[x86::NUM_IREGS-1] = 0xdeadbeef;
    ...
    SECTION("More INT state") {
        ...
        ctxt.producer_handshake.handshake.ctxt.regs_R.dw[x86::REG_EAX] = 0xfeedface;
        ctxt.producer_handshake.handshake.ctxt.regs_R.dw[x86::REG_ESP] = 0xfeedface;
        ctxt.producer_handshake.handshake.ctxt.regs_R.dw[x86::NUM_IREGS-1] = 0xfeedface;
    ...
    SECTION("FP state") {
        ...
        ctxt.producer_handshake.handshake.ctxt.regs_F.e[x86::NUM_FREGS-1] = M_PI;
    ...
    SECTION("XMM state") {
        ...
        ctxt.producer_handshake.handshake.ctxt.regs_XMM.qw[x86::NUM_XMMREGS-1].lo = 0xfeedface;
        ctxt.producer_handshake.handshake.ctxt.regs_XMM.qw[x86::NUM_XMMREGS-1].hi = 0xfeedface;
    ...
    SECTION("Segment base state") {
        ...
        ctxt.producer_handshake.handshake.ctxt.regs_SD.dw[x86::NUM_SREGS-1] = 0xfeedface;
    ...
    SECTION("Segment selector state") {
        ...
        ctxt.producer_handshake.handshake.ctxt.regs_S.w[1] = 0xface;
        ctxt.producer_handshake.handshake.ctxt.regs_S.w[x86::NUM_SREGS-2] = 0xfeed;
        ctxt.producer_handshake.handshake.ctxt.regs_S.w[x86::NUM_SREGS-1] = 0xface;
