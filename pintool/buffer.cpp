...
handshake_container_t* Buffer::operator[](int index) { return get_item(index); }

bool Buffer::empty() { return size_ == 0; }

bool Buffer::full() { return size_ == numPool_; }

int Buffer::size() { return size_; }

int Buffer::capacity() { return numPool_; }
